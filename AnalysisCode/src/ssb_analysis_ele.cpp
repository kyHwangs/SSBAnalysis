...
void ssb_analysis::Loop( char *logfile )
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) 
   {
      ...
      std::cout << jentry << "'th event : " << Elec_Count << " electrons exists" << std::endl;
      std::cout << std::setw(10) << "SC_ETA" << std::setw(3) << " | "
                << std::setw(10) << "SC_aETA" << std::setw(3) << " | "
                << std::setw(10) << "Loose?" << std::setw(3) << " | "
                << std::setw(10) << "Medium?" << std::setw(3) << " | "
                << std::setw(10) << "Tight?" << std::setw(3) << " | "
                << std::setw(10) << "Veto?" << std::setw(3) << " | "
                << std::setw(10) << "conv" << std::setw(3) << " | "
                << std::setw(10) << "sigiEiE" << std::setw(3) << " | "
                << std::setw(10) << "dEtaIn" << std::setw(3) << " | "
                << std::setw(10) << "dPhiIn" << std::setw(3) << " | "
                << std::setw(10) << "hOE" << std::setw(3) << " | "
                << std::setw(10) << "IsoRho3" << std::setw(3) << " | "
                << std::setw(10) << "IsoRho4" << std::setw(3) << " | "
                << std::setw(10) << "ooEmooP" << std::setw(3) << " | "
                << std::setw(10) << "HEEP" << std::setw(3) << " | "
                << std::endl;

   for (int i = 0; i < Elec_Count; i++) {
      std::cout << std::setprecision(5) << std::setfill('.')
                << std::setw(10) << Elec_Supercluster_Eta->at(i) << std::setw(3) << " | "
                << std::setw(10) << std::abs(Elec_Supercluster_Eta->at(i)) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_Loose->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_Medium->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_Tight->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_Veto->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_Conversion->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_sigmaIetaIeta->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_dEtaIn->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_dPhiIn->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_hOverE->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_PFIsoRho03->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_PFIsoRho04->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_ooEmooP->at(i) << std::setw(3) << " | "
                << std::setw(10) << Elec_SCB_HEEP->at(i) << std::setw(3) << " | "
                << std::endl;
   }
