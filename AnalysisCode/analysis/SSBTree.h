...
public :
  ...
  vector<bool>    *Muon_isHighPt_calc;
  vector<bool>    *Muon_isHighTrkPt_calc;
  vector<bool>    *Muon_isLoose_calc;
  vector<bool>    *Muon_isMedium_calc;
  vector<bool>    *Muon_isTight_calc;
  ...
  TBranch        *b_LHE_nParticle;
  TBranch        *b_LHE_particleID;
  ...
  TBranch        *b_Muon_isHighPt_calc;
  TBranch        *b_Muon_isHighTrkPt_calc;
  TBranch        *b_Muon_isLoose_calc;
  TBranch        *b_Muon_isMedium_calc;
  TBranch        *b_Muon_isTight_calc;
...
void SSBTree::Init(TTree *tree)
{
  ...
  Muon_isHighPt_calc = 0;
  Muon_isHighTrkPt_calc = 0;
  Muon_isLoose_calc = 0;
  Muon_isMedium_calc = 0;
  Muon_isTight_calc = 0;
  ...
  Muon_ValidTrackHitFraction = 0;
  Muon_GlobalTrackChi2 = 0;
  Muon_TrackerSTAPositionMatch = 0;
  Muon_TrackKink = 0;
  Muon_TrackExist = 0;
  Muon_SegmentCompatibility = 0;

  Muon_GlobalMuonTrackChamberHit = 0;
  Muon_TunePGlobalMuonTrackChamberHit = 0;
  Muon_TunePpTError = 0;
  Muon_TunePpT = 0;
  Muon_StationsHasSegments = 0;

  Muon_dxy = 0;
  Muon_dB = 0;
  Muon_dz = 0;
  Muon_PixelHit = 0;
  Muon_TrackLayerWithHit = 0;
  ...
  fChain->SetBranchAddress("LHE_nParticle", &LHE_nParticle, &b_LHE_nParticle);
  fChain->SetBranchAddress("LHE_particleID", &LHE_particleID, &b_LHE_particleID);
  ...
  fChain->SetBranchAddress("Muon_isHighPt_calc", &Muon_isHighPt_calc, &b_Muon_isHighPt_calc);
  fChain->SetBranchAddress("Muon_isHighTrkPt_calc", &Muon_isHighTrkPt_calc, &b_Muon_isHighTrkPt_calc);
  fChain->SetBranchAddress("Muon_isLoose_calc", &Muon_isLoose_calc, &b_Muon_isLoose_calc);
  fChain->SetBranchAddress("Muon_isMedium_calc", &Muon_isMedium_calc, &b_Muon_isMedium_calc);
  fChain->SetBranchAddress("Muon_isTight_calc", &Muon_isTight_calc, &b_Muon_isTight_calc);

  fChain->SetBranchAddress("Muon_isPF", &Muon_isPF, &b_Muon_isPF);
  fChain->SetBranchAddress("Muon_isGlobal", &Muon_isGlobal, &b_Muon_isGlobal);
  fChain->SetBranchAddress("Muon_isTracker", &Muon_isTracker, &b_Muon_isTracker);

  fChain->SetBranchAddress("Muon_ValidTrackHitFraction", &Muon_ValidTrackHitFraction, &b_Muon_ValidTrackHitFraction);
  fChain->SetBranchAddress("Muon_GlobalTrackChi2", &Muon_GlobalTrackChi2, &b_Muon_GlobalTrackChi2);
  fChain->SetBranchAddress("Muon_TrackerSTAPositionMatch", &Muon_TrackerSTAPositionMatch, &b_Muon_TrackerSTAPositionMatch);
  fChain->SetBranchAddress("Muon_TrackKink", &Muon_TrackKink, &b_Muon_TrackKink);
  fChain->SetBranchAddress("Muon_TrackExist", &Muon_TrackExist, &b_Muon_TrackExist);
  fChain->SetBranchAddress("Muon_SegmentCompatibility", &Muon_SegmentCompatibility, &b_Muon_SegmentCompatibility);

  fChain->SetBranchAddress("Muon_GlobalMuonTrackChamberHit", &Muon_GlobalMuonTrackChamberHit, &b_Muon_GlobalMuonTrackChamberHit);
  fChain->SetBranchAddress("Muon_TunePGlobalMuonTrackChamberHit", &Muon_TunePGlobalMuonTrackChamberHit, &b_Muon_TunePGlobalMuonTrackChamberHit);
  fChain->SetBranchAddress("Muon_TunePpTError", &Muon_TunePpTError, &b_Muon_TunePpTError);
  fChain->SetBranchAddress("Muon_TunePpT", &Muon_TunePpT, &b_Muon_TunePpT);
  fChain->SetBranchAddress("Muon_StationsHasSegments", &Muon_StationsHasSegments, &b_Muon_StationsHasSegments);

  fChain->SetBranchAddress("Muon_dxy", &Muon_dxy, &b_Muon_dxy);
  fChain->SetBranchAddress("Muon_dB", &Muon_dB, &b_Muon_dB);
  fChain->SetBranchAddress("Muon_dz", &Muon_dz, &b_Muon_dz);
  fChain->SetBranchAddress("Muon_PixelHit", &Muon_PixelHit, &b_Muon_PixelHit);
  fChain->SetBranchAddress("Muon_TrackLayerWithHit", &Muon_TrackLayerWithHit, &b_Muon_TrackLayerWithHit);
