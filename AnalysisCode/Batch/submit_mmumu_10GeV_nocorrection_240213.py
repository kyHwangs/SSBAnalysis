...
if __name__ == '__main__':
    Study = "240213_10GeV_noCorr" 

    #              sampleName,         outputName, NumFileList, NumJob, isData, eraName, roccorUse, idisoUse, trigUse, massCut

    Make_CondorScr("Data_SingleMuon_Run2016B"   , Study, 1054 , 106 , "true", "Run2016B",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016C"   , Study, 348  , 35  , "true", "Run2016C",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016D"   , Study, 584  , 59  , "true", "Run2016D",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016E"   , Study, 496  , 50  , "true", "Run2016E",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016F"   , Study, 362  , 37  , "true", "Run2016F",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016G"   , Study, 854  , 86  , "true", "Run2016G",   "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016HV2" , Study, 925  , 93  , "true", "Run2016HV2", "false", "false", "false", 10)
    Make_CondorScr("Data_SingleMuon_Run2016HV3" , Study, 25   , 3   , "true", "Run2016HV3", "false", "false", "false", 10)

    Make_CondorScr("DYJetsToLL_M_10To50"        , Study, 178  , 18 , "false", "DY_10To50",  "false", "false", "false", 10)
    Make_CondorScr("DYJetsToLL_M_50"            , Study, 732  , 74 , "false", "DY_50",      "false", "false", "false", 10)
    Make_CondorScr("ST_tW_antitop"              , Study, 70   , 7  , "false", "tW_antitop", "false", "false", "false", 10)
    Make_CondorScr("ST_tW_top"                  , Study, 71   , 8  , "false", "tW_top",     "false", "false", "false", 10)
    Make_CondorScr("TTJets_Signal"              , Study, 621  , 63 , "false", "TTJets",     "false", "false", "false", 10)
    Make_CondorScr("WJetsToLNu"                 , Study, 120  , 12 , "false", "WJets",      "false", "false", "false", 10)
    Make_CondorScr("WW"                         , Study, 81   , 9  , "false", "WW",         "false", "false", "false", 10)
    Make_CondorScr("WZ"                         , Study, 41   , 5  , "false", "WZ",         "false", "false", "false", 10)
    Make_CondorScr("ZZ"                         , Study, 21   , 3  , "false", "ZZ",         "false", "false", "false", 10)
